...
namespace haberblog.Controllers
{
    public class ServisController : ApiController
    {
        ...
        { 
            ...
            { 
                sonuc.islem = false; 
                sonuc.mesaj = "Girilen KullanıcıAdı veya E-Posta Adresi Kayıtlıdır!"; 
                return sonuc; 
            } 
            Uye yeni = new Uye(); 
		...
		[HttpGet] 
        [Route("api/yorumliste")] public List<YorumModel> YorumListe() 
        { 
        ...
        { 
            ...
            { 
                sonuc.islem = false; 
                sonuc.mesaj = "Aynı Kişi, Aynı Haber Aynı Yorumu Yapamaz!"; 
                return sonuc; 
            } 
